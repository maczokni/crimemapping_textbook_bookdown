...
Ok, so most likely you concluded that the process wasn't random, which it isn't in truth. It is also likely that you identified a number of potential hotspots, like in the map below:

Now let's go back to the map you produced for violence in the city centre...



##Studying the relationship between types of points