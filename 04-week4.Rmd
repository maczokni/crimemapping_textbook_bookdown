# Week 4: Performing spatial operations in R
...
You can change the background as well. We played arouns with this already so don't spend too much time, but remember how you can see a list of the available basemaps? Well, you can also find a list with some previews included [here](http://leaflet-extras.github.io/leaflet-providers/preview/index.html).
