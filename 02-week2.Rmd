# Week 2: Making your first maps in R
...
You could also accompany the coordinates with a  zoom argument, an integer from 3 to 20 specifying how large the spatial extent should be around the center, with 3 being the continent level and 20 being roughly the single building level. 
...
1. How could you characterise the basemap as a vector map or as a raster image?
2. How could you characterise the layer representing the crimes as a vector map or as a raster image?
