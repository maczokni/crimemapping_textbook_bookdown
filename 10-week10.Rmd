...
```{r}
data_url <-"https://raw.githubusercontent.com/maczokni/2018_labs/master/data/2017-11-greater-manchester-street.csv"
gmpcrime <- read_csv(url(data_url))
x<-read_csv("https://www.dropbox.com/s/dfjdo7ct6hczu0j/gmp.csv?dl=0")
x1
```
